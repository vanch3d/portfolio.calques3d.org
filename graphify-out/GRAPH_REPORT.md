...
- 256 files · ~117,795 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 1272 nodes · 1663 edges · 140 communities (105 shown, 21 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `f5f67823`
...
### Community 5 - "validate-content.mjs"
...
Cohesion: 0.06
Nodes (32): name, packageManager, private, version, ajv, @base-ui/react, clsx, cypress-terminal-report (+24 more)
...
Cohesion: 0.11
Nodes (17): groupByYear(), ADR, ADRStatus, CaseStudy, CaseStudyStatus, ChapterMeta, Coordinates, CVData (+9 more)
...
Cohesion: 0.20
Nodes (11): EraColumn(), EraColumnProps, EraEntry, EraLink, RulerTick(), RulerYear(), ENGINEERING_POSITIONS, RESEARCH_POSITIONS (+3 more)
...
Cohesion: 0.29
Nodes (9): vitest, buildSprinkle(), pickSprinkle(), Project, extractYear(), formatPeriod(), EngineeringProject, ProjectBase (+1 more)
...
Cohesion: 0.18
Nodes (12): IdentityBlock(), SiteNav(), SiteNavProps, dynamic, HomePage(), ENGINEERING_DIR, getAllEngineeringProjects(), getEngineeringProjectBySlug() (+4 more)

### Community 40 - "NamedRuleCard.tsx"

Cohesion: 0.33
Nodes (5): NamedRuleCard(), NamedRuleCardProps, FLAT, NO_DECORATION, ONE_RED
...
### Community 61 - "AdrIndexClient.tsx"
...
Cohesion: 0.38
Nodes (5): CV_DIR, getEducation(), getSkills(), EducationRecord, SkillGroup

### Community 137 - "research.ts"

Cohesion: 0.43
Nodes (5): getResearchProjectBySlug(), getResearchSlugs(), importResearchMDX(), parseFrontmatter(), RESEARCH_DIR

### Community 139 - "types/adr.ts"
...
- **626 isolated node(s):** `AdrRegisterHeaderProps`, `AdrRegisterTableProps`, `InsightCalloutStripProps`, `AdrFrontmatter`, `InsightFrontmatter` (+621 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 730 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `react` connect `react` to `TagFilterDrawer.tsx`, `app/page.tsx`, `package.json`, `NavLink.tsx`, `atoms/page.tsx`, `cn`, `AdrIndexClient.tsx`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `vitest` connect `vitest` to `positions.ts`, `content/index.ts`, `cv.ts`, `package.json`, `app/page.tsx`, `research.ts`, `content.ts`, `handlers/zotero.ts`, `citation.ts`, `markdown.ts`, `api/zotero.ts`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `TagFilterDrawer.tsx`, `SectionLabel.tsx`, `NamedRuleCard.tsx`, `NavLink.tsx`, `atoms/page.tsx`, `ColorSwatch.tsx`, `TypeSpecimen.tsx`, `AdrIndexClient.tsx`?**
