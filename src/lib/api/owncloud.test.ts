...
describe('buildFileUrl', () => {
  it('builds a URL from base + collection + encoded filename', () => {
    ...
    expect(url).toBe('https://assets.example.org/remote.php/webdav/portfolio/my%20paper.pdf')
  })
  ...
  it('strips trailing slash from apiUrl before joining', () => {
    ...
    expect(url).toBe('https://assets.example.org/remote.php/webdav/portfolio/doc.pdf')
  })
