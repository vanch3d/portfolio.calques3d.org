...
const RESEARCH_PROPS = {
  ...
  badge: "Era I",
  name: "Research",
  summary: "AI in Education · Human-Computer Interaction · Peer-reviewed scholarship across seven research institutions.",
...
const ENGINEERING_PROPS = {
  ...
  badge: "Era II",
  name: "Engineering",
  summary: "Frontend engineering · Product UX · IoT & SaaS platforms at HubSpot, HiveMQ, Matillion.",
  positions: ENGINEERING_POSITIONS,
  positionsAriaLabel: "Engineering positions, newest first",
  links: [
    { href: "/engineering" as Route, label: "Explore engineering →" },
  ],
};
