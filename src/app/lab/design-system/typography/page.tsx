  ...
  return (
    <main className="page-wrap py-xl">
      ...
      <section aria-labelledby="specimens-heading" className="mb-2xl">
        ...
        <div className="flex flex-col">
          ...
          <TypeSpecimen
            ...
            specs={[t('spec_spectral'), t('spec_medium_500'), t('spec_title_size')]}
      ...
      <section aria-labelledby="type-rules-heading">
        ...
        <div className="mb-xl grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-md">
          <NamedRuleCard name={t('incline_rule_name')} statement={t('incline_rule_body')} />
        </div>
