...
const HEADLINE = {
  ...
  rationale:
    "STIX Two Text italic at headline scale — used for section and project titles.",
};
...
const TITLE = {
  ...
  rationale:
    "Spectral at medium weight — designed for screens, academic without stiffness.",
};
...
const LABEL = {
  ...
  rationale:
    "Space Mono — distinctive tabular-figures monospace with instrument-panel character.",
};
...
describe("TypeSpecimen", () => {
  ...
  it("merges additional className on the outer wrapper", () => {
    cy.mountAccessible(
      <TypeSpecimen {...DISPLAY} className="mt-xl" />
    );
