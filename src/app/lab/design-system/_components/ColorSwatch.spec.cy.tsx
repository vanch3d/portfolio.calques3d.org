...
const INK = {
  ...
  hex: '#2a2a2a',
  usage: 'Primary lines, headings, body text. The weight of a freshly-sharpened pencil.',
...
const ACTIVE = {
  ...
  hex: '#c0392b',
  usage: 'The single active construction element per surface. Never used for decoration.',
...
describe('ColorSwatch', () => {
  ...
  it('swatch block has the correct aria-label', () => {
    cy.mountAccessible(<ColorSwatch {...INK} />)
    cy.get('[role="img"]').should('have.attr', 'aria-label', INK.ariaLabel)
  })
