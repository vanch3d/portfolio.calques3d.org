...
export function NamedRuleCard({
  ...
  return (
    <article
      className={cn(
        "border-medium border-ink-ghost px-lg py-md",
        className,
      )}
    >
      <p className="label mb-sm">{name}</p>
      <p className="font-body font-medium text-body leading-label text-ink mb-xs">
        {statement}
      </p>
      {rationale && (
